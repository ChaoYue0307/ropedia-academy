...
# LLM agent — tool use (ReAct)  🚧 placeholder
...
| **Built on** | [huggingface/transformers (function calling)](https://huggingface.co/docs/transformers/main/en/chat_extras) |
| **Track** | AG · Agents & RL |
| **Notebook** | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/AG_llm_agent_tooluse.ipynb) |
| **Compute / storage / time** | see the *Compute · storage · time* table inside the notebook (GPU required) |

## How to fill this repo
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/AG_llm_agent_tooluse.ipynb) → **Runtime → GPU → Run all** (trains/runs the real pipeline).
...
## Links to tracks A–D
Relates to: **C · D · LM** — see the *How this links to tracks A–D* note in the notebook.

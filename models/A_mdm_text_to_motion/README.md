...
# MDM — text-to-motion  🚧 placeholder
...
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/A_mdm_text_to_motion.ipynb) → **Runtime → GPU → Run all** (trains/runs the real pipeline).
...
## Links to tracks A–D
Relates to: **LM · AG** — see the *How this links to tracks A–D* note in the notebook.

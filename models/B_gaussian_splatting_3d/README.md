...
# 3D Gaussian Splatting  🚧 placeholder
...
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/B_gaussian_splatting_3d.ipynb) → **Runtime → GPU → Run all** (trains/runs the real pipeline).

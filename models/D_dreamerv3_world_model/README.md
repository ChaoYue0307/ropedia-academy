...
# DreamerV3 — world-model RL  🚧 not trained yet
...
| **Built on** | [danijar/dreamerv3](https://github.com/danijar/dreamerv3) |
| **Notebook** | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/D_dreamerv3_world_model.ipynb) |
...
## Evaluation results
⏳ **Pending** — run the notebook on a GPU to fill this in. This lab reports **mean evaluation-episode return** on a held-out split (see its *Evaluate* cell).
...
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/D_dreamerv3_world_model.ipynb) → **Runtime → GPU → Run all** (runs the real pipeline).
...
## License
Code: **MIT** (this repository). The **base model** ([danijar/dreamerv3](https://github.com/danijar/dreamerv3)) and **dataset** are each under their own licenses — check the upstream source before redistribution.

...
# Stable Diffusion — LoRA / DreamBooth  🚧 placeholder
...
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/LM_stable_diffusion_lora.ipynb) → **Runtime → GPU → Run all** (trains/runs the real pipeline).
...
## Links to tracks A–D
Relates to: **A · B** — see the *How this links to tracks A–D* note in the notebook.

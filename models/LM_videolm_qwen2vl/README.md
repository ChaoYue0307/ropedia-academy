...
| **Built on** | [QwenLM/Qwen2-VL](https://github.com/QwenLM/Qwen2-VL) |
| **Track** | LM · Language & multimodal |
| **Notebook** | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/LM_videolm_qwen2vl.ipynb) |
| **Compute / storage / time** | see the *Compute · storage · time* table inside the notebook (GPU required) |

## How to fill this repo
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/LM_videolm_qwen2vl.ipynb) → **Runtime → GPU → Run all** (trains/runs the real pipeline).
...
## Links to tracks A–D
Relates to: **A · C** — see the *How this links to tracks A–D* note in the notebook.

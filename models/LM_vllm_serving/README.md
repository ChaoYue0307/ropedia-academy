...
1. Open the [notebook in Colab](https://colab.research.google.com/github/ChaoYue0307/ropedia-academy/blob/main/notebooks/advanced/LM_vllm_serving.ipynb) → **Runtime → GPU → Run all** (trains/runs the real pipeline).

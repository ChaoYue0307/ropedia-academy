...
export const S: Dict = {
  ...
  objectives: { en: "By the end you can", zh: "学完你将能够" },
  bigIdeasTitle: { en: "Big ideas across the curriculum", zh: "贯穿课程的核心思想" },
  bigIdeasIntro: {
    en: "Most methods here are variations on a handful of recurring principles. Learn these once and a new paper becomes a variant of something you already understand.",
    zh: "这里的大多数方法，都是少数反复出现的原则的变体。把它们学透一次，一篇新论文就会变成你已理解之物的变体。",
  },
  appearsIn: { en: "Appears in", zh: "出现于" },
  recurringIdeas: { en: "Recurring ideas", zh: "反复出现的思想" },
  ...
  leadsTo: { en: "Where this leads & reappears", zh: "由此通向 / 再次出现" },
  checkYourself: { en: "Check yourself", zh: "自我检验" },
  quickCheck: { en: "Quick check", zh: "快速检测" },
  nextQuestion: { en: "Next question", zh: "下一题" },
  correctFeedback: { en: "Correct", zh: "正确" },
  incorrectFeedback: { en: "Not quite", zh: "不太对" },
  ...
  liveDemos: { en: "Try the live demos", zh: "在线体验 Demo" },
